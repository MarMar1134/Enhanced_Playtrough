...
public class PrimalGrinderMenu extends AbstractContainerMenu {
    ...
    public PrimalGrinderMenu(int containerID, Inventory inv, FriendlyByteBuf extraData){
    ...
    public PrimalGrinderMenu(int containerID, Inventory inv, BlockEntity entity, ContainerData data){
        ...
        addSlots((PrimalGrinderBlockEntity) entity);

        addDataSlots(data);
    }

    private void addSlots(PrimalGrinderBlockEntity entity){
        //Input
        ...
        entity.getFuelLazyHandler().ifPresent(itemStackHandler ->
                addSlot(new SlotItemHandler(itemStackHandler, 0, 44, 53){
                    @Override
                    public boolean mayPlace(@NotNull ItemStack stack) {
                        return isFuel(stack);
                    }

...
public class EPOresPlacedFeatures {
    ...
    public static void bootstrap(BootstapContext<PlacedFeature> context){
        ...
        //Tin
        register(context, SMALL_TIN_ORES_PLACED, configuredFeatures.getOrThrow(EPOresConfiguredFeatures.SMALL_TIN_ORES),
                EPOrePlacement.commonOrePlacement(7,
                        HeightRangePlacement.triangle(VerticalAnchor.absolute(-40), VerticalAnchor.absolute(30))));

        register(context, BIG_TIN_ORES_PLACED, configuredFeatures.getOrThrow(EPOresConfiguredFeatures.BIG_TIN_ORES),
                EPOrePlacement.commonOrePlacement(12,
                        HeightRangePlacement.triangle(VerticalAnchor.absolute(20), VerticalAnchor.absolute(120))));

        register(context, EXTRA_TIN_ORES_PLACED, configuredFeatures.getOrThrow(EPOresConfiguredFeatures.SMALL_TIN_ORES),
        ...
        register(context, EXTRA_SULFUR_ORES_PLACED, configuredFeatures.getOrThrow(EPOresConfiguredFeatures.SMALL_SULFUR_ORES),
                EPOrePlacement.commonOrePlacement(5,

...
public class AppleFoliagePlacer extends FoliagePlacer {
    public static final Codec<AppleFoliagePlacer> CODEC = RecordCodecBuilder.create(instance ->
            foliagePlacerParts(instance).and(Codec.intRange(0,16).fieldOf("height").forGetter(fp -> fp.height))
                    .apply(instance, AppleFoliagePlacer::new));
    ...
    protected FoliagePlacerType<?> type() {
        return EPFoliagePlacers.APPLE_FOLIAGE_PLACER.get();
    }

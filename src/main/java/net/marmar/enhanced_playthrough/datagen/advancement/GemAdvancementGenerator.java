...
public class GemAdvancementGenerator implements ForgeAdvancementProvider.AdvancementGenerator, iAdvancementUtils {
    public final ItemPredicate HAS_POLISHER = ItemPredicate.Builder.item().of(EPTags.Items.POLISHER).build();
    public final ItemPredicate HAS_SMALL_FLOWER = ItemPredicate.Builder.item().of(ItemTags.SMALL_FLOWERS).build();
    public final ItemPredicate HAS_TALL_FLOWER = ItemPredicate.Builder.item().of(ItemTags.TALL_FLOWERS).build();
    public final ItemPredicate HAS_ANY_ROTTEN_CROP = ItemPredicate.Builder.item()
    ...
    public ResourceLocation categoryBackGround() {
        return new ResourceLocation("minecraft","textures/block/emerald_block.png");
    }

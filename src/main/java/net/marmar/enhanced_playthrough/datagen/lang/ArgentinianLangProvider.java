...
public class ArgentinianLangProvider extends AbstractLangProvider {
    ...
    protected void addTranslations() {
        ...
        //Advancements
            ...
            addSurvivalAdvancement("design_choices", "Elección de diseño",
                    "Fundí oro y aluminio para obtener oro morado.");
            addSurvivalAdvancement("the_man_behind_the_slaughter", "Hace años que ocurrió...",
                    "Matá a 5 aldeanos pequeños con una daga de hierro con mango de oro morado.");
            ...
            addGemAdvancement("first_flower", "La raiz de todo",
                    "Obtené tu primer flor");
            addGemAdvancement("all_small_flowers", "David",
                    "Obtené todas las flores pequeñas");
        ...
        //Blocks
            ...
            addBlock(EPBlocks.WILD_CORN_CROP, "Choclo silvestre");
        ...
        //Ore blocks
        addBlock(EPBlocks.RAW_TIN_BLOCK, "Bloque de estaño crudo");
        ...
        //Items
        //Raw ores
        addItem(EPItems.RAW_TIN, "Estaño crudo");
        addItem(EPItems.RAW_ZINC, "Zinc crudo");
        addItem(EPItems.RAW_SILVER, "Plata cruda");
        addItem(EPItems.RAW_ALUMINUM, "Aluminio crudo");
        ...
        //Other tools
        addItem(EPItems.FLINT_AND_COBBLE, "Encendedor de adoquines");
        addItem(EPItems.FLINT_AND_BRONZE, "Encendedor de bronce");
        ...
        //Food
            ...
            addItem(EPItems.ZAPALLO_SEEDS, "Semillas de calabaza");
            addItem(EPItems.TOMATO_SEEDS, "Semillas de tomate");
            addItem(EPItems.CORN_SEEDS, "Semillas de choclo");
            ...
            //Vegetables
            addItem(EPItems.CORN, "Choclo");
            addItem(EPItems.ZAPALLO, "Calabaza");

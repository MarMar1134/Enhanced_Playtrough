package net.marmar.enhanced_playthrough.datagen.lang;
...
public class SpanishLangProvider extends AbstractLangProvider {
    ...
    protected void addTranslations() {
        ...
        addCreativeTab("purple_gold_tools", "Herramientas con mango de oro morado");
        ...
        //Blocks
            ...
            addBlock(EPBlocks.WILD_CORN_CROP, "Mazorca silvestre");

            //Plants
            addBlock(EPBlocks.TALL_REEDS, "Cañabera");
            addBlock(EPBlocks.REEDS, "Hierba de las pampas");
            addBlock(EPBlocks.KENAF, "Kenaf");
            addBlock(EPBlocks.SMALL_REEDS, "Hierba de las pampas andina");
        ...
        //Ores
        addBlock(EPBlocks.TIN_ORE, "Mena de estaño");
        addBlock(EPBlocks.DEEPSLATE_TIN_ORE, "Mena de estaño de pizarra profunda");
        addBlock(EPBlocks.ZINC_ORE, "Mena de zinc");
        addBlock(EPBlocks.DEEPSLATE_ZINC_ORE, "Mena de zinc de pizarra profunda");
        addBlock(EPBlocks.NETHER_ZINC_ORE, "Mena de zinc del nether");
        addBlock(EPBlocks.NETHER_COPPER_ORE, "Mena de cobre del nether");
        addBlock(EPBlocks.SULFUR_ORE, "Mena de azufre");
        addBlock(EPBlocks.DEEPSLATE_SULFUR_ORE, "Mena de azufre de pizarra profunda");
        addBlock(EPBlocks.NETHER_SULFUR_ORE, "Mena de azufre del nether");
        addBlock(EPBlocks.SILVER_ORE, "Mena de plata");
        addBlock(EPBlocks.DEEPSLATE_SILVER_ORE, "Mena de plata de pizarra profunda");
        addBlock(EPBlocks.SAPPHIRE_ORE, "Mena de zafiro");
        addBlock(EPBlocks.DEEPSLATE_SAPPHIRE_ORE, "Mena de zaphiro de pizarra profunda");
        addBlock(EPBlocks.RUBY_ORE, "Mena de rubi");
        addBlock(EPBlocks.DEEPSLATE_RUBY_ORE, "Mena de rubi de pizarra profunda");
        addBlock(EPBlocks.NETHER_GARNET_ORE, "Mena de granate del nether");
        addBlock(EPBlocks.COBALT_ORE, "Mena de cobalto");
        addBlock(EPBlocks.DEEPSLATE_COBALT_ORE, "Mena de cobalto de pizarra profunda");
        ...
        addBlock(EPBlocks.PURPLE_GOLD_BLOCK, "Bloque de oro morado");
        ...
        addItem(EPItems.RAW_RUBY, "Rubí impuro");
        ...
        addItem(EPItems.BLUE_GOLD_NUGGET, "Pepita de oro azul");
        addItem(EPItems.PURPLE_GOLD_INGOT, "Lingote de oro morado");
        addItem(EPItems.PURPLE_GOLD_NUGGET, "Pepita de oro morado");
        ...
        addItem(EPItems.PURPLE_GOLD_ROD, "Vara de oro morado");
        ...
        //Dusts
        addItem(EPItems.GOLD_DUST, "Polvo de oro");
        addItem(EPItems.SILVER_DUST, "Polvo de plata");
        addItem(EPItems.ALUMINUM_DUST, "Polvo de aluminio");
        addItem(EPItems.ZINC_DUST, "Polvo de zinc");
        addItem(EPItems.TIN_DUST, "Polvo de estaño");
        addItem(EPItems.COPPER_DUST, "Polvo de cobre");
        addItem(EPItems.BRASS_DUST, "Polvo de latón");
        addItem(EPItems.BRONZE_DUST, "Polvo de bronce");
        addItem(EPItems.ROSE_GOLD_DUST, "Polvo de oro rosado");
        addItem(EPItems.IRON_DUST, "Polvo de hierro");
        addItem(EPItems.BRONZIUM_DUST, "Polvo de broncio");
        addItem(EPItems.GREEN_GOLD_DUST, "Polvo de oro verde");
        addItem(EPItems.STEEL_DUST, "Polvo de acero");
        addItem(EPItems.BLUE_GOLD_DUST, "Polvo de oro azul");
        addItem(EPItems.PURPLE_GOLD_DUST, "Polvo de oro morado");
        ...
        addItem(EPItems.SILVER_PICKAXE, "Pico de plata");
        ...
        addItem(EPItems.SILVER_CHESTPLATE, "Peto de plata");
        addItem(EPItems.SILVER_LEGGINGS, "Grebas de plata");
        ...
        addItem(EPItems.BRASS_PICKAXE, "Pico de latón");
        ...
        addItem(EPItems.BRASS_CHESTPLATE, "Peto de latón");
        addItem(EPItems.BRASS_LEGGINGS, "Grebas de latón");
        ...
        addItem(EPItems.BRONZE_PICKAXE, "Pico de bronce");
        ...
        addItem(EPItems.BRONZE_CHESTPLATE, "Peto de bronce");
        addItem(EPItems.BRONZE_LEGGINGS, "Grebas de bronce");
        ...
        addItem(EPItems.ROSE_GOLDEN_PICKAXE, "Pico de oro rosado");
        ...
        addItem(EPItems.ROSE_GOLDEN_CHESTPLATE, "Peto de oro rosado");
        addItem(EPItems.ROSE_GOLDEN_LEGGINGS, "Grebas de oro rosado");
        ...
        addItem(EPItems.BRONZIUM_PICKAXE, "Pico de broncio");
        ...
        addItem(EPItems.BRONZIUM_CHESTPLATE, "Peto de broncio");
        addItem(EPItems.BRONZIUM_LEGGINGS, "Grebas de broncio");
        ...
        addItem(EPItems.GREEN_GOLDEN_PICKAXE, "Pico de oro verde");
        ...
        addItem(EPItems.GREEN_GOLDEN_CHESTPLATE, "Peto de oro verde");
        addItem(EPItems.GREEN_GOLDEN_LEGGINGS, "Grebas de oro verde");
        ...
        addItem(EPItems.STEEL_PICKAXE, "Pico de acero");
        ...
        addItem(EPItems.STEEL_CHESTPLATE, "Peto de acero");
        addItem(EPItems.STEEL_LEGGINGS, "Grebas de acero");
        ...
        addItem(EPItems.BLUE_GOLDEN_PICKAXE, "Pico de oro azul");
        ...
        addItem(EPItems.BLUE_GOLDEN_CHESTPLATE, "Peto de oro azul");
        addItem(EPItems.BLUE_GOLDEN_LEGGINGS, "Grebas de oro azul");
        ...
        //Food
            ...
            addItem(EPItems.WILD_CORN, "Mazorca silvestre");
            ...
            addItem(EPItems.CORN_SEEDS, "Semillas de mazorca");

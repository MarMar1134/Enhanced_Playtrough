package net.marmar.enhanced_playthrough.datagen.loot.block;
...
public class VanillaIBlockLootTables extends BlockLootSubProvider implements IBlockLootTableBuilders {

    public VanillaIBlockLootTables() {

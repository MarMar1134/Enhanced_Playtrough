...
import net.marmar.enhanced_playthrough.recipe.epsmelt.EPSmeltingRecipeBuilder;
...
public class SmeltingRecipeSubProvider extends RecipeProvider {
    ...
    public static void addSmeltingRecipes(Consumer<FinishedRecipe> consumer){
        ...
        //Smelting Recipes
            ...
            oreSmelting(consumer, EPTags.Items.SILVER_SMELT_TO_NUGGET, EPItems.SILVER_NUGGET.get(), 0.1f, "silver_nugget");
            oreBlasting(consumer, EPTags.Items.SILVER_SMELT_TO_NUGGET, EPItems.SILVER_NUGGET.get(), 0.1f, "silver_nugget");
            ...
            //brass
            oreSmelting(consumer, EPTags.Items.BRASS_SMELT_TO_NUGGET, EPItems.BRASS_NUGGET.get(), 0.1f, "brass_nugget");
            oreBlasting(consumer, EPTags.Items.BRASS_SMELT_TO_NUGGET, EPItems.BRASS_NUGGET.get(), 0.1f, "brass_nugget");

            oreBlasting(consumer, EPItems.BRASS_DUST.get(), EPItems.BRASS_INGOT.get(), 0.5f, "brass_ingot");

            //bronze
            oreSmelting(consumer, EPTags.Items.BRONZE_SMELT_TO_NUGGET, EPItems.BRONZE_NUGGET.get(), 0.1f, "bronze_nugget");
            oreBlasting(consumer, EPTags.Items.BRONZE_SMELT_TO_NUGGET, EPItems.BRONZE_NUGGET.get(), 0.1f, "bronze_nugget");

            oreBlasting(consumer, EPItems.BRONZE_DUST.get(), EPItems.BRONZE_INGOT.get(), 0.5f, "bronze_ingot");

            //rose gold
            oreSmelting(consumer, EPTags.Items.ROSE_GOLD_SMELT_TO_NUGGET, EPItems.ROSE_GOLD_NUGGET.get(), 0.1f, "rose_gold_nugget");
            oreBlasting(consumer, EPTags.Items.ROSE_GOLD_SMELT_TO_NUGGET, EPItems.ROSE_GOLD_NUGGET.get(), 0.1f, "rose_gold_nugget");
            ...
            //Bronzium
            oreBlasting(consumer, EPTags.Items.BRONZIUM_SMELT_TO_NUGGET, EPItems.BRONZIUM_NUGGET.get(), 0.1f, "bronzium_nugget");

            oreBlasting(consumer, EPItems.BRONZIUM_DUST.get(), EPItems.BRONZIUM_INGOT.get(), 0.5f, "bronzium_ingot");

            //Green gold
            oreBlasting(consumer, EPTags.Items.GREEN_GOLD_SMELT_TO_NUGGET, EPItems.GREEN_GOLD_NUGGET.get(), 0.1f, "green_gold_nugget");

            oreBlasting(consumer, EPItems.GREEN_GOLD_DUST.get(), EPItems.GREEN_GOLD_INGOT.get(), 0.5f, "green_gold_ingot");

            //Steel
            oreBlasting(consumer, EPTags.Items.STEEL_SMELT_TO_NUGGET, EPItems.STEEL_NUGGET.get(), 0.1f, "steel_nugget");

            oreBlasting(consumer, EPItems.STEEL_DUST.get(), EPItems.STEEL_INGOT.get(), 0.5f, "steel_ingot");

            //Blue gold
            oreBlasting(consumer, EPTags.Items.BLUE_GOLD_SMELT_TO_NUGGET, EPItems.BLUE_GOLD_NUGGET.get(), 0.1f, "blue_gold_nugget");

            oreBlasting(consumer, EPItems.BLUE_GOLD_DUST.get(), EPItems.BLUE_GOLD_INGOT.get(), 0.5f, "blue_gold_ingot");

            //Purple gold
            oreBlasting(consumer, EPItems.PURPLE_GOLD_DUST.get(), EPItems.PURPLE_GOLD_INGOT.get(), 0.5f, "purple_gold");

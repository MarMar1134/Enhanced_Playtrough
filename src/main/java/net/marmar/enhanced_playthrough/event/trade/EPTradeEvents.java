package net.marmar.enhanced_playthrough.event.trade;
    ...
    public static void subscribeTrades(VillagerTradesEvent event){
        ...
        if (event.getType() == VillagerProfession.FARMER){
            ...
            trades.get(3).add((pTrader, pRandom) -> new MerchantOffer(
                    new ItemStack(EPItems.RICE_GRAINS.get(), 15),
                    new ItemStack(Items.EMERALD, 1),
                    16, 10, 0.2f));
            trades.get(3).add((pTrader, pRandom) -> new MerchantOffer(
                    new ItemStack(Items.EMERALD, 1),
                    new ItemStack(EPItems.RICE_BOWL.get(), 1),
                    12, 15, 0.5f));
        ...
        if (event.getType() == VillagerProfession.LEATHERWORKER){
            ...
            //Level 1
            trades.get(1).add((pTrader, pRandom) -> new MerchantOffer(
                    new ItemStack(EPItems.COW_HIDE.get(), 4),
                    new ItemStack(Items.EMERALD, 1),
                    new ItemStack(Items.LEATHER, 6),
                    16, 2, 0.05f));
            trades.get(1).add((pTrader, pRandom) -> new MerchantOffer(
                    new ItemStack(EPItems.PIG_HIDE.get(), 4),
                    new ItemStack(Items.EMERALD, 1),
                    new ItemStack(Items.LEATHER, 6),
                    16, 2, 0.05f));
            trades.get(1).add((pTrader, pRandom) -> new MerchantOffer(
                    new ItemStack(EPItems.COW_HIDE.get(), 6),
                    new ItemStack(Items.EMERALD, 1),
                    16, 2, 0.05f));
            trades.get(1).add((pTrader, pRandom) -> new MerchantOffer(
                    new ItemStack(EPItems.PIG_HIDE.get(), 6),
                    new ItemStack(Items.EMERALD, 1),
                    16, 2, 0.05f));
            ...
            //Level 3
            trades.get(3).add((pTrader, pRandom) -> new MerchantOffer(
                    new ItemStack(Items.RABBIT_HIDE, 9),
                    new ItemStack(EPItems.SAPPHIRE.get(), 1),
                    16, 15, 0.05f));
            trades.get(3).add((pTrader, pRandom) -> new MerchantOffer(
                    ...
                    16, 15, 0.05f));
            trades.get(3).add((pTrader, pRandom) -> new MerchantOffer(
                    new ItemStack(EPItems.WERELLAGER_HIDE.get(), 4),
                    new ItemStack(EPItems.SAPPHIRE.get(), 1),
                    new ItemStack(Items.LEATHER, 6),
                    16, 15, 0.05f));
            trades.get(3).add((pTrader, pRandom) -> new MerchantOffer(
                    new ItemStack(EPItems.WERELLAGER_HIDE.get(), 6),
                    new ItemStack(EPItems.SAPPHIRE.get(), 1),
                    16, 15, 0.05f));

            //Level 4
            trades.get(4).add((pTrader, pRandom) -> new MerchantOffer(
                    new ItemStack(Items.SCUTE, 6),
                    new ItemStack(EPItems.SAPPHIRE.get(), 1),
                    16, 15, 0.2f));
            trades.get(4).add((pTrader, pRandom) -> ITradeOffers.enchantedItemOffer(
                    pRandom, EPItems.SAPPHIRE.get(), 2, Items.LEATHER_HELMET, 5, 20));
            trades.get(4).add((pTrader, pRandom) -> ITradeOffers.enchantedItemOffer(
                    pRandom, EPItems.SAPPHIRE.get(), 5, Items.LEATHER_CHESTPLATE, 5, 20));
            trades.get(4).add((pTrader, pRandom) -> ITradeOffers.enchantedItemOffer(
                    pRandom, EPItems.SAPPHIRE.get(), 4, Items.LEATHER_LEGGINGS, 5, 20));
            trades.get(4).add((pTrader, pRandom) -> ITradeOffers.enchantedItemOffer(
                    pRandom, EPItems.SAPPHIRE.get(), 3, Items.LEATHER_BOOTS, 5, 20));
            trades.get(4).add((pTrader, pRandom) -> new MerchantOffer(
                    new ItemStack(Items.EMERALD, 6),
            ...
            //Level 5
            trades.get(5).add((pTrader, pRandom) -> new MerchantOffer(
                    new ItemStack(Items.LEATHER, 24),
                    new ItemStack(EPItems.RUBY.get(), 1),
                    16, 30, 0.2f));
            trades.get(5).add((pTrader, pRandom) -> new MerchantOffer(
                    new ItemStack(Items.EMERALD, 6),

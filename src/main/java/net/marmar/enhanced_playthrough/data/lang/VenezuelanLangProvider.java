...
public class VenezuelanLangProvider extends AbstractLangProvider {
    ...
    protected void addTranslations() {
        ...
        addBlock(EPBlocks.SOUL_MUD_BRICKS, "Ladrillos de barro de almas");
        addBlock(EPBlocks.SOUL_MUD_BRICK_SLAB, "Baldosa de ladrillos de barro de almas");
        addBlock(EPBlocks.SOUL_MUD_BRICK_STAIRS, "Escaleras de ladrillos de barro de almas");
        addBlock(EPBlocks.SOUL_MUD_BRICK_WALL, "Pared de ladrillos de barro de almas");

...
import net.marmar.enhanced_playthrough.data.loot.advancement.EPAdvancementLootTables;
import net.marmar.enhanced_playthrough.data.loot.block.EPIBlockLootTables;
import net.marmar.enhanced_playthrough.data.loot.chest.EPChestLootTables;
import net.marmar.enhanced_playthrough.data.loot.block.VanillaIBlockLootTables;
import net.marmar.enhanced_playthrough.data.loot.entity.EPEntityLootTables;
import net.marmar.enhanced_playthrough.data.loot.entity.VanillaEntityLootTables;

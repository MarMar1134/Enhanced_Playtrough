...
public class PrimitiveAlloyingCategory implements IRecipeCategory<PrimitiveAlloyRecipe> {
    public static final ResourceLocation UID = new ResourceLocation(EnhancedPlaythrough.MOD_ID, "primitive_ore_alloying");
    ...
    public static final RecipeType<PrimitiveAlloyRecipe> PRIMITIVE_ALLOY_RECIPE_TYPE =
            new RecipeType<>(UID, PrimitiveAlloyRecipe.class);
    ...
    public PrimitiveAlloyingCategory(IGuiHelper helper) {
        ...
        this.icon = helper.createDrawableIngredient(VanillaTypes.ITEM_STACK, new ItemStack(EPBlocks.PRIMITIVE_ALLOY_FURNACE.get()));
    }

    @Override
    public void draw(PrimitiveAlloyRecipe recipe, IRecipeSlotsView recipeSlotsView, GuiGraphics guiGraphics, double mouseX, double mouseY) {
    ...
    public RecipeType<PrimitiveAlloyRecipe> getRecipeType() {
        return PRIMITIVE_ALLOY_RECIPE_TYPE;
    }

    @Override
    public Component getTitle() {
        return Component.translatable("jei." + EnhancedPlaythrough.MOD_ID + ".primitive_alloy_furnace");
    }
    ...
    @Override
    public void setRecipe(IRecipeLayoutBuilder builder, PrimitiveAlloyRecipe recipe, IFocusGroup focuses) {

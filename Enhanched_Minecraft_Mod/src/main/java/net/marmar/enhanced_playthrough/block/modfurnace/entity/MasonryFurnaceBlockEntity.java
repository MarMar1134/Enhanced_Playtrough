...
public class MasonryFurnaceBlockEntity extends AbstractModFurnaceBlockEntity implements MenuProvider {

    public MasonryFurnaceBlockEntity(BlockPos pPos, BlockState pBlockState) {
        super(ModBlockEntities.MASONRY_FURNACE_BLOCK_ENTITY.get(), pPos, pBlockState, ModRecipes.MASONRY_SMELTING_TYPE.get());
    }

...
public class EnhancedPlaythroughJadePlugin implements IWailaPlugin {
    public static final ResourceLocation BASIC_FURNACE = new ResourceLocation(EnhancedPlaythrough.MOD_ID, "basic_furnace");
    ...
    public void register(IWailaCommonRegistration registration) {
        registration.registerBlockDataProvider(BasicFurnaceComponentProvider.INSTANCE, AbstractBasicFurnaceBlockEntity.class);
    ...
    public void registerClient(IWailaClientRegistration registration) {
        registration.registerBlockComponent(BasicFurnaceComponentProvider.INSTANCE, AbstractBasicFurnaceBlock.class);

...
public interface ICustomAdvancementDisplays {
    ...
    default Component advancementTitle(String advancementName){
        return Component.translatable("advancement." + EnhancedPlaythrough.MOD_ID + ".title." + categoryName() + "." + advancementName);
    }

    default Component advancementDesc(String advancementName){
        return Component.translatable("advancement." + EnhancedPlaythrough.MOD_ID + ".desc." + categoryName() + "." + advancementName);
    }

    default DisplayInfo baseDisplayInfo(ItemLike pIcon, Component title, Component desc, FrameType frameType){
        return new DisplayInfo(new ItemStack(pIcon.asItem()), title, desc, categoryBackGround(), frameType, true, true, true);
    }

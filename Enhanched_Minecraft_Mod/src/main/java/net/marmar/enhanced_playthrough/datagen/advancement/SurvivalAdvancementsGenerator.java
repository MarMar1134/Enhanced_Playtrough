...
public class SurvivalAdvancementsGenerator implements ForgeAdvancementProvider.AdvancementGenerator {
    ...
    public void generate(HolderLookup.Provider provider, Consumer<Advancement> consumer, ExistingFileHelper existingFileHelper) {
        Advancement survival_root = Advancement.Builder.advancement()
                .display(ModBlocks.ADOBE_ALLOYING_FURNACE.get(), Component.translatable("advancements.title.survival.unity_makes_strength"), Component.translatable("advancements.desc.survival.unity_makes_strength"), SURVIVAL_BACKGROUND, FrameType.TASK, false, false, true)
        ...
        Advancement thats_new = Advancement.Builder.advancement()
                ...
                .display(ModItems.BRONZE_INGOT.get(), Component.translatable(""), Component.translatable(""), SURVIVAL_BACKGROUND, FrameType.TASK, true, true, false)

...
public class SpanishLanguageProvider extends AbstractModLanguageProvider{
    ...
    protected void addTranslations() {
        ...
        addAdvancementTitle("survival", "bubbles", "Cáctus");
        ...
        addAdvancementDesc("gems", "polish_sapphire", "Consiga algunos záfiros y visitá un rato el mar");
        ...
        addBlock(ModBlocks.DEEPSLATE_RUBI_ORE, "Mena de rubi de pizarra profunda");

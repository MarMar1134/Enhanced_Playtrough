...
public class UruguayanLanguageProvider extends AbstractModLanguageProvider{
    ...
    protected void addTranslations() {
        ...
        addAdvancementDesc("survival", "blossom", "Fundí oro y cobre para obtener oro rosado");
        addAdvancementDesc("survival", "buttercup", "Fundí oro y plata para obtener oro verde");
        addAdvancementDesc("survival", "bubbles", "Fundí oro y cobalto para obtener oro azul");
        addAdvancementDesc("survival", "the_goldenpuff_girls", "Conseguí las tres aleaciones de oro");
        addAdvancementDesc("survival", "thats_new", "Obtené un lingote de bronce");
        addAdvancementDesc("survival", "abrassive_heat", "Obtené un lingote de latón");
        ...
        addAdvancementDesc("gems", "polish_sapphire", "Consegui algunos záfiros y visitá un rato el mar");

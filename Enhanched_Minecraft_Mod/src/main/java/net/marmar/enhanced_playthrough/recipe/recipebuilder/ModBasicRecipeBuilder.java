...
public class ModBasicRecipeBuilder implements RecipeBuilder {
    ...
    public static ModBasicRecipeBuilder itemGrinding(Ingredient pIngredient, ItemLike pResult, String group, int quantity, RecipeSerializer<? extends AbstractGrindRecipe> pCookingSerializer) {
        return new ModBasicRecipeBuilder(pResult, quantity, pIngredient, ModRecipeCategory.MECHANICAL_GRIND, group, pCookingSerializer);
    }
    @Override

...
public class ModAlloyingRecipeBuilder implements RecipeBuilder {
    ...
    private ModAlloyingRecipeBuilder(AlloyRecipeCategory recipeCategory, String pGroup, int alloyingTime, ItemLike pResult, int count, Ingredient firstIngredient, Ingredient secondIngredient, RecipeSerializer<?> pSerializer) {
    ...
    public static ModAlloyingRecipeBuilder oreAlloying(Ingredient firstIngredient, Ingredient secondIngredient, AlloyRecipeCategory recipeCategory, ItemLike pResult, String group, RecipeSerializer<? extends AlloyingFurnaceRecipe> pCookingSerializer) {
        return new ModAlloyingRecipeBuilder(recipeCategory, group, 200, pResult, 1, firstIngredient, secondIngredient, pCookingSerializer);
    }

    public static ModAlloyingRecipeBuilder superOreAlloying(Ingredient firstIngredient, Ingredient secondIngredient, AlloyRecipeCategory recipeCategory, ItemLike pResult, String group, int count, RecipeSerializer<? extends SuperAlloyingRecipe> pCookingSerializer) {
        return new ModAlloyingRecipeBuilder(recipeCategory, group, 100, pResult, count, firstIngredient, secondIngredient, pCookingSerializer);
    }

package net.marmar.enhanced_playthrough.recipe.basicsmelt;
...
public class SoulBasicSmeltRecipe extends AbstractBasicSmeltRecipe implements Recipe<SimpleContainer> {
    private final Ingredient input;
    private final int CoockingTime;
    private final ModRecipeCategory category;
    private final String group;

    public SoulBasicSmeltRecipe(Ingredient input, ItemStack output, ResourceLocation id, int cookingTime, ModRecipeCategory category, String group) {
    ...
    public static class Type implements RecipeType<SoulBasicSmeltRecipe>{
        public static final Type INSTANCE = new Type();
        private static String ID = "soul_basic_smelting";
    }
    public static class Serializer implements RecipeSerializer<SoulBasicSmeltRecipe>{
        ...
        @Override
        public SoulBasicSmeltRecipe fromJson(ResourceLocation resourceLocation, JsonObject jsonObject) {
            ...
            return new SoulBasicSmeltRecipe(input, output, resourceLocation, cookTime, recipeCategory, group);
        }

        @Override
        public @Nullable SoulBasicSmeltRecipe fromNetwork(ResourceLocation resourceLocation, FriendlyByteBuf friendlyByteBuf) {
            ...
            return new SoulBasicSmeltRecipe(input, output, resourceLocation, alloyTime, recipeCategory, group);
        }

        @Override
        public void toNetwork(FriendlyByteBuf friendlyByteBuf, SoulBasicSmeltRecipe recipe) {

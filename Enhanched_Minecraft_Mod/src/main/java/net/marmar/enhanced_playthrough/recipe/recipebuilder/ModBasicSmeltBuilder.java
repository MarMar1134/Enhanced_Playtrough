...
public class ModBasicSmeltBuilder implements RecipeBuilder {
    ...
    public static ModBasicSmeltBuilder basicSmelting(Ingredient input, ItemLike result, String group, RecipeSerializer<BasicSmeltRecipe> serializer){
        return new ModBasicSmeltBuilder(ModRecipeCategory.BASIC_SMELT, group, 300, result, input, serializer);
    }

    public static ModBasicSmeltBuilder soulBasicSmelting(Ingredient input, ItemLike result, String group, RecipeSerializer<SoulBasicSmeltRecipe> serializer){

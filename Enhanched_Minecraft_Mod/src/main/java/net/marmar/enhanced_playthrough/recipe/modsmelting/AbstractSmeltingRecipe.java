...
public abstract class AbstractSmeltingRecipe implements Recipe<SimpleContainer> {
    ...
    public AbstractSmeltingRecipe(Ingredient input, ItemStack output, ResourceLocation id, int coockingTime, ModRecipeCategory category, String group) {
        this.input = input;
        this.output = output;
        this.id = id;

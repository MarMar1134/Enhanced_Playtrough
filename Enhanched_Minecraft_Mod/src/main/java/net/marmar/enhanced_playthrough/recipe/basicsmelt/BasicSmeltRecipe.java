...
public class BasicSmeltRecipe extends AbstractBasicSmeltRecipe implements Recipe<SimpleContainer> {
    private final Ingredient input;
    private final int CoockingTime;
    private final ModRecipeCategory category;
    private final String group;

    public BasicSmeltRecipe(Ingredient input, ItemStack output, ResourceLocation id, int cookingTime, ModRecipeCategory category, String group) {
    ...
    public static class Type implements RecipeType<BasicSmeltRecipe>{
        public static final Type INSTANCE = new Type();
        private static String ID = "basic_smelting";
    }
    public static class Serializer implements RecipeSerializer<BasicSmeltRecipe>{
        ...
        @Override
        public BasicSmeltRecipe fromJson(ResourceLocation resourceLocation, JsonObject jsonObject) {
            ...
            return new BasicSmeltRecipe(input, output, resourceLocation, cookTime, recipeCategory, group);
        }

        @Override
        public @Nullable BasicSmeltRecipe fromNetwork(ResourceLocation resourceLocation, FriendlyByteBuf friendlyByteBuf) {
            ...
            return new BasicSmeltRecipe(input, output, resourceLocation, alloyTime, recipeCategory, group);
        }

        @Override
        public void toNetwork(FriendlyByteBuf friendlyByteBuf, BasicSmeltRecipe recipe) {

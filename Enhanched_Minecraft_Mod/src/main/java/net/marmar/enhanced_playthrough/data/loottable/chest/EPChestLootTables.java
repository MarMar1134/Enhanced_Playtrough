...
//                        .add(LootItem.lootTableItem(Items.CANDLE).setWeight(3)
...
//                                  .apply(SetItemCountFunction.setCount(UniformGenerator.between(1.0F, 3.0F))))
//                        .add(LootItem.lootTableItem(Items.GLOW_BERRIES).setWeight(3)
//                                .apply(SetItemCountFunction.setCount(UniformGenerator.between(1.0F, 15.0F))))
//                        .add(LootItem.lootTableItem(Items.IRON_LEGGINGS).setWeight(3)
//                                .apply(EnchantWithLevelsFunction.enchantWithLevels(UniformGenerator.between(20.0F, 39.0F))
//                                        .allowTreasure()))
//                        .add(LootItem.lootTableItem(Items.ECHO_SHARD).setWeight(4)
//                                .apply(SetItemCountFunction.setCount(UniformGenerator.between(1.0F, 3.0F))))
//                        .add(LootItem.lootTableItem(Items.DISC_FRAGMENT_5).setWeight(4)
//                                .apply(SetItemCountFunction.setCount(UniformGenerator.between(1.0F, 3.0F))))
//                        .add(LootItem.lootTableItem(Items.POTION).setWeight(5)
//                                .apply(SetItemCountFunction.setCount(UniformGenerator.between(1.0F, 3.0F)))
...
//                                .apply(SetItemCountFunction.setCount(UniformGenerator.between(1.0F, 15.0F))))
//                        .add(LootItem.lootTableItem(Items.SOUL_TORCH).setWeight(5)
//                                .apply(SetItemCountFunction.setCount(UniformGenerator.between(1.0F, 15.0F))))

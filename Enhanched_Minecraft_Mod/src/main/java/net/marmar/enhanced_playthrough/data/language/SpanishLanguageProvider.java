...
public class SpanishLanguageProvider extends AbstractModLanguageProvider{
    ...
    protected void addTranslations() {
        ...
        //Blocks
            ...
            addBlock(ModBlocks.WILD_CORN, "Mazorca silvestre");

            //Plants
            addBlock(ModBlocks.TALL_REEDS, "Cañabera");
            addBlock(ModBlocks.REEDS, "Hierba de las pampas");
            addBlock(ModBlocks.SMALL_REEDS, "Hierba de las pampas andina");
        ...
        addBlock(ModBlocks.DEEPSLATE_TIN_ORE, "Mena de estaño de pizarra profunda");
        addBlock(ModBlocks.ZINC_ORE, "Mena de zinc");
        addBlock(ModBlocks.DEEPSLATE_ZINC_ORE, "Mena de zinc de pizarra profunda");
        ...
        addBlock(ModBlocks.DEEPSLATE_SULFUR_ORE, "Mena de azufre de pizarra profunda");
        addBlock(ModBlocks.NETHER_SULFUR_ORE, "Mena de azufre del nether");
        addBlock(ModBlocks.SILVER_ORE, "Mena de plata");
        addBlock(ModBlocks.DEEPSLATE_SILVER_ORE, "Mena de plata de pizarra profunda");
        addBlock(ModBlocks.SAPPHIRE_ORE, "Mena de zafiro");
        addBlock(ModBlocks.DEEPSLATE_SAPPHIRE_ORE, "Mena de zaphiro de pizarra profunda");
        addBlock(ModBlocks.RUBY_ORE, "Mena de rubi");
        addBlock(ModBlocks.DEEPSLATE_RUBY_ORE, "Mena de rubi de pizarra profunda");
        ...
        //Ore blocks
        addBlock(ModBlocks.RAW_TIN_BLOCK, "Bloque de estaño en bruto");
        addBlock(ModBlocks.TIN_BLOCK, "Bloque de estaño");
        addBlock(ModBlocks.RAW_ZINC_BLOCK, "Bloque de zinc en bruto");
        addBlock(ModBlocks.ZINC_BLOCK, "Bloque de zinc");
        addBlock(ModBlocks.RAW_SILVER_BLOCK, "Bloque de plata en bruto");
        addBlock(ModBlocks.SILVER_BLOCK, "Bloque de plata");
        addBlock(ModBlocks.RAW_ALUMINUM_BLOCK, "Bloque de aluminio en bruto");
        ...
        addItem(ModItems.RAW_RUBY, "Rubí impuro");
        ...
        addItem(ModItems.BLUE_GOLDEN_CHESTPLATE, "Peto de oro azul");
        ...
        //Food
            ...
            addItem(ModItems.WILD_CORN, "Mazorca silvestre");
            ...
            addItem(ModItems.CORN_SEEDS, "Semillas de mazorca");

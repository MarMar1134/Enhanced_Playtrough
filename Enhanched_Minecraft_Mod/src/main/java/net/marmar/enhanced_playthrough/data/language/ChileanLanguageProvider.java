...
public class ChileanLanguageProvider extends AbstractModLanguageProvider{
    ...
    protected void addTranslations() {
        ...
        addBlock(ModBlocks.DEEPSLATE_RUBY_ORE, "Mineral de rubi profundo");
        ...
        addItem(ModItems.BLUE_GOLDEN_PICKAXE, "Picota de oro azul");
        ...
        addEnchantmentDesc("fine_mining", "Al ser aplicado en una picota, permite obtener solo el mineral al picar un bloque de mineral");
        addEnchantment(ModEnchantments.ROUGH_MINING, "Maldición de minado bruzco");
        addEnchantmentDesc("rough_mining", "Al ser aplicado a una picota, impide que los minerales sean recolectados al picar un bloque de mineral");

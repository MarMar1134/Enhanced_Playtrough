...
public class MechanicalGrinderMenu extends AbstractContainerMenu {
    public final MechanicalGrinderBlockEntity blockEntity;
    private final Level level;
    private final ContainerData data;

    public MechanicalGrinderMenu(int containerID, Inventory inv, FriendlyByteBuf extraData){
    ...
    public MechanicalGrinderMenu(int containerID, Inventory inv, BlockEntity entity, ContainerData data){
        ...
        addSlots((MechanicalGrinderBlockEntity) entity);
    ...
    private void addSlots(MechanicalGrinderBlockEntity entity){
        //Input

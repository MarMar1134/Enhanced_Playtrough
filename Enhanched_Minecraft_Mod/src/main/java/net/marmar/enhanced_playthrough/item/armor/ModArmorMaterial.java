package net.marmar.enhanced_playthrough.item.armor;
...
public enum ModArmorMaterial implements ArmorMaterial {
    ...
    ModArmorMaterial(String name, int durabilityMultiplier, int[] protectionAmounts, int enchantmenValue, SoundEvent equipSound, float toughness, float knockbackResistance, Supplier<Ingredient> repairIngredient) {
        this.name = name;

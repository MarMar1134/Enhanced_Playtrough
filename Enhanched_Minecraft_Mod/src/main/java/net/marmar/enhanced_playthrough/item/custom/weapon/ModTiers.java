...
public class ModTiers {
    public static final Tier SILVER = TierSortingRegistry.registerTier(
            ...
            new ResourceLocation(EnhancedPlaythrough.MOD_ID, "silver_armor"), List.of(Tiers.GOLD),
            List.of(Tiers.IRON)
    );
    public static final Tier BRASS = TierSortingRegistry.registerTier(
            ...
            new ResourceLocation(EnhancedPlaythrough.MOD_ID, "brass_armor"), List.of(Tiers.STONE),
            List.of(Tiers.IRON)
    );
    public static final Tier BRONZE = TierSortingRegistry.registerTier(
            ...
            new ResourceLocation(EnhancedPlaythrough.MOD_ID, "bronze_armor"), List.of(Tiers.STONE),
            List.of(Tiers.IRON)
    );
    public static final Tier ROSE_GOLD = TierSortingRegistry.registerTier(
            ...
            new ResourceLocation(EnhancedPlaythrough.MOD_ID, "rose_gold_armor"), List.of(Tiers.STONE),
            List.of(Tiers.IRON)
    );
    public static final Tier BRONZIUM = TierSortingRegistry.registerTier(
            ...
            new ResourceLocation(EnhancedPlaythrough.MOD_ID, "bronzium_armor"), List.of(Tiers.IRON),
            List.of(Tiers.DIAMOND)
    );
    public static final Tier STEEL = TierSortingRegistry.registerTier(
            new ForgeTier(2, 908, 7F, 3f, 16,
                    ModTags.Blocks.NEEDS_STEEL_TOOL,() -> Ingredient.of(ModItems.STEEL_INGOT.get())),
            new ResourceLocation(EnhancedPlaythrough.MOD_ID, "steel_armor"), List.of(Tiers.IRON),
                    List.of(Tiers.DIAMOND)
    );
    public static final Tier GREEN_GOLD = TierSortingRegistry.registerTier(
            ...
            new ResourceLocation(EnhancedPlaythrough.MOD_ID, "green_gold_armor"), List.of(Tiers.IRON),
            List.of(Tiers.DIAMOND)
    );
    public static final Tier BLUE_GOLD = TierSortingRegistry.registerTier(
            ...
            new ResourceLocation(EnhancedPlaythrough.MOD_ID, "blue_gold_armor"), List.of(Tiers.IRON),
            List.of(Tiers.DIAMOND)
    );
}
